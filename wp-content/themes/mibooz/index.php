...
<section class="blog-page">
    <div class="container">
        ...
        <?php echo do_shortcode('[ajax_load_more container_type="div" transition_container_classes="row large-12" post_type="post" posts_per_page="3" pause="true" offset="3" button_done_label="No More Posts...."]'); ?>
