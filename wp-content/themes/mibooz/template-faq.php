...
<section class="faq-page">
    <div class="faq-page-shape" style="background-image: url(<?php echo esc_url(the_field('page_shape_background','option')); ?>)"></div>
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="faq-page__bottom">
                    <p class="faq-page__bottom-text"><?php echo esc_attr(the_field('subtitle','option')); ?> <a
                            href="<?php echo esc_attr(the_field('title_link','option')); ?>"><?php echo esc_attr(the_field('title','option')); ?></a></p>
                </div>
            </div>
        </div>
    </div>
...
<section class="contact-page">
    <div class="container">
        <div class="section-title text-center">
            <span class="section-title__tagline"><?php echo esc_attr(the_field('contact_form_subtitle','option')); ?></span>
            <h2 class="section-title__title"><?php echo esc_attr(the_field('contact_form_title','option')); ?></h2>
        </div>
        <div class="row">
            <div class="col-xl-12">
