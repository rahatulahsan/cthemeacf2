...
<?php require_once('inc/breadcumb.php'); ?>
                            ...
                            <ul class="list-unstyled about-page__images">
                                ...
                                <li>
                                    <div class="about-page__img-1">
                                        <img src="<?php echo $about['about_image_1']; ?>" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="about-page__img-2">
                                        <img src="<?php echo $about['about_image_2']; ?>" alt="">
                                    </div>
                                </li>
                            </ul>
                            <div class="about-page__badge"><img data-tilt
                                    src="<?php echo $about['about_page_badge']; ?>" alt=""></div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="about-page__right">
                            <div class="section-title text-left">
                                <span class="section-title__tagline"><?php echo $about['subtitle']; ?></span>
                                <h2 class="section-title__title"><?php echo $about['title']; ?></h2>
                            </div>
                            <p class="about-page__right-text-1"><?php echo $about['content']; ?></p>
                            <h4 class="about-page__right-text-2"><?php echo $about['featured_title']; ?></h4>
                            <a href="<?php echo $about['button_link']; ?>" class="thm-btn abut-page__btn"><?php echo $about['button_title']; ?></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="design-studio services-page-design-studio">
            <div class="design-studio-bg-box">
                ...
                <div class="design-studio-bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%"
                    styles="background-image: url(<?php echo $video_details['video_background_image']; ?>)">
            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="design-studio__inner">
                        <h2 class="design-studio__title"><?php echo $video_details['video_title']; ?></h2>
                        <div class="design-studio__video-link">
                            <a href="<?php echo $video_details['video_link']; ?>" class="video-popup">
        ...
        <section class="testimonial-two about-page-testimonial-two">
            ...
            <div class="testimonial-two-shape wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms"><img
                    src="<?php echo $reviews['right_side_shape']; ?>" alt=""></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="testimonial-two__left wow slideInLeft" data-wow-delay="100ms"
                            ...
                            <div class="testimonial-two__img">
                                <img src="<?php echo $reviews['left_side_image']; ?>" alt="">
                                <div class="testimonial-two__content">
                                    <h3 class="testimonial-two__title"><?php echo $reviews['image_hashtag_title']; ?></span></h3>
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="testimonial-two__right">
                            <div class="section-title text-left">
                                <span class="section-title__tagline"><?php echo $reviews['review_subtitle']; ?></span>
                                <h2 class="section-title__title"><?php echo $reviews['review_title']; ?></h2>
                            </div>
                            ...
                            while($query->have_posts()){
                                $query->the_post(); ?>
                                 ...
                                 <div class="testimonial-two__single">
                                    <p class="testimonial-two__text"><?php the_content(); ?></p>
                                    <div class="testimonial-two__client-info">
                                        ...
                                        <div class="testimonial-two__client-details">
                                            ...
                                            <p class="testimonial-two__client-title"><?php the_field('designation'); ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php }
        ...
        <section class="team-one">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <span class="section-title__tagline"><?php echo $teams['team_subtitle']; ?></span>
                    <h2 class="section-title__title"><?php echo $teams['team_heading']; ?></h2>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="best-agency__left">
                            <div class="section-title text-left">
                                ...
                                ?>
                                <span class="section-title__tagline"><?php echo $faqs['faq_subtitle']; ?></span>
                                <h2 class="section-title__title"><?php echo $faqs['faq_title']; ?></h2>
                            </div>
                            <ul class="list-unstyled best-agency__points">
                                <li>
                                    ...
                                    <div class="text">
                                        <p><?php echo $faqs['featured_text_1']; ?></p>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon">
                                    ...
                                    <div class="text">
                                        <p><?php echo $faqs['featured_text_2']; ?></p>
                                    </div>
                                </li>
                            </ul>
                            <div class="best-agency__experience">
                                <div class="best-agency__experience-icon">
                                    <span class="<?php echo $faqs['featured_icon']; ?>"></span>
                                </div>
                                <div class="best-agency__experience-text-box">
                                    <p class="best-agency__experience-text"><?php echo $faqs['featured_contents']; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
