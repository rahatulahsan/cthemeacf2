...
<head>
    ...
    <title>Blog Details || Mibooz || Mibooz HTML Template For Business</title>
    <!-- favicons Icons -->
                                ...
                                <ul>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="index3.html">Header Two</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                ...
                <div class="container">
                    <div class="site-footer__top-inner">
                        <div class="site-footer__top-left">
                            ...
                            <a href="tel:926668880000" class="site-footer__top-left-phone">+ 92 666 888 0000</a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="site-footer__bottom-inner">
                                <p class="site-footer__bottom-text">© Copyrights, <span class="dynamic-year"></span> <a href="#">Layerdrops.com</a>
                                </p>
                            </div>
                        </div>
                    </div>
